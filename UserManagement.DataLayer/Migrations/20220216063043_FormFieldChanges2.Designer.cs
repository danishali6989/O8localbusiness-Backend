...
namespace UserManagement.DataLayer.Migrations
{
    ...
    [Migration("20220216063043_FormFieldChanges2")]
    partial class FormFieldChanges2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.Entities.FormField", b =>
                {
                    ...
                    b.Property<int>("FormBuilderTypeId");
            ...
            modelBuilder.Entity("UserManagement.Entities.FormField", b =>
                {
                    b.HasOne("UserManagement.Entities.FormBuilderType", "FormBuilderType")
                        .WithMany()
                        .HasForeignKey("FormBuilderTypeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
